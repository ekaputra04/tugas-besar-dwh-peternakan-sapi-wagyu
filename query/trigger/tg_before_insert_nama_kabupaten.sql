-- cleansing pada tb_kabupaten
DELIMITER / / CREATE TRIGGER dbt_peternakan_sapi_wagyu.before_insert_nama_kabupaten BEFORE
INSERT
    ON dbt_peternakan_sapi_wagyu.tb_kabupaten FOR EACH ROW BEGIN DECLARE new_alamat VARCHAR(255);
