...
DELIMITER / / CREATE TRIGGER dbt_peternakan_sapi_wagyu.before_insert_alamat_pelanggan BEFORE
INSERT
    ON dbt_peternakan_sapi_wagyu.tb_pelanggan FOR EACH ROW BEGIN DECLARE new_alamat VARCHAR(255);

SET
    new_alamat = UPPER(NEW.alamat_pelanggan);
...
SET
    NEW.alamat_pelanggan = new_alamat;
