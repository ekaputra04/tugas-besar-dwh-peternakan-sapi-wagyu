...
DELIMITER / / CREATE TRIGGER dbt_peternakan_sapi_wagyu.before_insert_alamat_pegawai BEFORE
INSERT
    ON dbt_peternakan_sapi_wagyu.tb_pegawai FOR EACH ROW BEGIN DECLARE new_alamat VARCHAR(255);

SET
    new_alamat = UPPER(NEW.alamat_pegawai);
