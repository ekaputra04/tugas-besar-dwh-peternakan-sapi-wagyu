...
DELIMITER / / CREATE TRIGGER dbt_peternakan_sapi_wagyu.before_insert_alamat_pemasok_pakan BEFORE
INSERT
    ON dbt_peternakan_sapi_wagyu.tb_pemasok_pakan FOR EACH ROW BEGIN DECLARE new_alamat VARCHAR(255);

SET
    new_alamat = UPPER(NEW.alamat_pemasok_pakan);
...
SET
    NEW.alamat_pemasok_pakan = new_alamat;
